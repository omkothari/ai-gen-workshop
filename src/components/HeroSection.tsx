...
const REGISTRATION_LINK = "https://forms.gle/VpEArx5gufFMZtfq6";
      ...
      <div className="relative z-10 section-container py-20">
        ...
        >
          ...
          <motion.div
            ...
            className="flex flex-wrap items-center justify-center gap-6 sm:gap-8 mb-8 grid grid-cols-3 sm:flex"
          >
            {/* IIIT Vadodara */}
